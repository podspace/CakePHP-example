...
// This is where we define the PodSpace specific secure variable functions
include(dirname(dirname(dirname(__FILE__))) . DS . 'lib' . DS . 'PodSpace.php');
...
// This function gets called by PodSpace_secure and passes an array
...
// Generate PodSpace secure keys (or return defaults if not on PodSpace)
$key_list = PodSpace_secure($_default_keys,'make_secure_key');
