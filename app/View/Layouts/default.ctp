...
<head>
  ...
  <title>Welcome to PodSpace</title>
...
<section class='container'>
          <hgroup>
            <h1>Welcome to your CakePHP application on PodSpace</h1>
          </hgroup>
          ...
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>How to use this example application</h2>
                <p>For instructions on how to use this application with PodSpace, start by reading the <a href="http://docs.PodSpace.org/latest/dev_guide/templates.html#using-the-quickstart-templates">Developer Guide</a>.</p>

              <h2>Deploying code changes</h2>
                <p>
                  The source code for this application is available to be forked from the <a href="https://www.github.com/PodSpace/Cake-PHP-example">PodSpace GitHub repository</a>.
                  You can configure a webhook in your repository to make PodSpace automatically start a build whenever you push your code:
                </p>
...
<ol>
  ...
  <li>Paste your webhook URL provided by PodSpace</li>
  <li>Leave the defaults for the remaining fields &mdash; that's it!</li>
</ol>
<p>After you save your webhook, if you refresh your settings page you can see the status of the ping that Github sent to PodSpace to verify it can reach the server.</p>
<p>Note: adding a webhook requires your PodSpace server to be reachable from GitHub.</p>

                <h3>Working in your local Git repository</h3>
                <p>If you forked the application from the PodSpace GitHub example, you'll need to manually clone the repository to your local system. Copy the application's source code Git URL and then run:</p>

<pre>$ git clone &lt;git_url&gt; &lt;directory_to_create&gt;

# Within your project directory
# Commit your changes and push to PodSpace
...
oc deploy cakephp-mysql-example --latest
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <p>Documentation on how to manage your application from the Web Console or Command Line is available at the <a href="http://docs.PodSpace.org/latest/dev_guide/overview.html">Developer Guide</a>.</p>

                <h3>Web Console</h3>
                <p>You can use the Web Console to view the state of your application components and launch new builds.</p>

                <h3>Command Line</h3>
                <p>With the <a href="http://docs.PodSpace.org/latest/cli_reference/overview.html">PodSpace command line interface</a> (CLI), you can create applications and manage projects from a terminal.</p>

                <h2>Development Resources</h2>
                  <ul>
                    <li><a href="http://docs.PodSpace.org/latest/welcome/index.html">PodSpace Documentation</a></li>
                    <li><a href="https://github.com/PodSpace/origin">PodSpace Origin GitHub</a></li>
                    <li><a href="https://github.com/PodSpace/source-to-image">Source To Image GitHub</a></li>
                    <li><a href="http://docs.PodSpace.org/latest/using_images/s2i_images/php.html">Getting Started with PHP on PodSpace</a></li>
                    <li><a href="http://stackoverflow.com/questions/tagged/PodSpace">Stack Overflow questions for PodSpace</a></li>
        ...
        <footer>
          <div class="logo"><a href="https://www.PodSpace.com/"></a></div>
        </footer>
</section>
