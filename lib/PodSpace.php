...
//  }
function PodSpace_secure($default_keys,$secure_function = null) {
  // Attempts to get secret token from CAKEPHP_SECRET_TOKEN,
  // generated in PodSpace template in PodSpace/templates.
  ...
  // Only generate random values if on PodSpace
  $array = $default_keys;
